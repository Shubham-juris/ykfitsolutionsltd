...
import image4 from "../assets/ykfitImage/image6.jpg";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-gray-800 p-4 rounded-lg text-center">
            <img
              ...
              className="w-full h-48 object-cover mb-4 rounded"
            />
            <h3 className="text-xl font-bold mb-2">OFFICE 365 INTEGRATION</h3>
            <p className="text-sm">
              Our website development team creates well-applications designed to
              meet specific business requirements. Having a website surely will
              give your business the online presence it needs.
          ...
          <div className="bg-gray-800 p-4 rounded-lg text-center">
            <img
              ...
              className="w-full h-48 object-cover mb-4 rounded"
            />
            <h3 className="text-xl font-bold mb-2">DESKTOP & USER SUPPORT</h3>
            <p className="text-sm">
              ...
              management and maintenance and mobile device.
            </p>
          </div>
        </div>
      </div>
